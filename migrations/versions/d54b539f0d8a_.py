...
Revision ID: d54b539f0d8a
Revises: 
Create Date: 2021-02-20 09:42:24.272157
...
def upgrade():
    ...
    op.create_table('approved_work_email_address_domains',
    sa.Column('email_address_domain', sa.String(), nullable=False),
    sa.PrimaryKeyConstraint('email_address_domain')
    )
    op.create_table('approved_work_email_addresses',
    ...
    sa.Column('mental_health_triggers', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('mental_health_baseline_behavior', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('no_contact_orders', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    ...
    sa.Column('datetime_verification_code_created', sa.DateTime(), server_default=sa.text('now()'), nullable=True),
...
def downgrade():
    ...
    op.drop_table('approved_work_email_addresses')
    op.drop_table('approved_work_email_address_domains')
    # ### end Alembic commands ###
